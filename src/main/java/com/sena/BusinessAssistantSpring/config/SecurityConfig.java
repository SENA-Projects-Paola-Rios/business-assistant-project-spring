...
public class SecurityConfig {
	...
	/*
	 * en esta clase se configuran los parametros de seguridad
	 * tambien el filtro que el api va a usar
	 * y las condiciones al momento de filtrar recursos del api, asi como el modo
	 * stateless de la aplicacion
	 * */
